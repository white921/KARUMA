...
const { BOT_ID, TEXT_CHANNEL_IDS, THREAD_IDS } = require("../dist/constant/shared/id.js");
const { COURT_SHOP_PANEL_MESSAGES } = require("../dist/constant/panel/panel.js");
const { SHOP_TICKET_TYPE, SHOP_TICKET_NONE } = require("../dist/constant/market/shopTicket.js");
const { createCourtShopPanelActionRow } = require("../dist/panel/market/shopPanelService.js");
...
const { handleModalSubmit } = require("../dist/handler/interaction/modalHandler.js");
