...
export const DARK_SHOP_PANEL_MESSAGES = {
  TITLE: "闇市場パネル",
  DESCRIPTION:
    `闇市場の商品購入はこちらのパネルから行ってください。\n市場割引券は使用できません。\n商品案内は[闇市商品一覧](https://discord.com/channels/1534636292153807039/1534644437328728164)にてご確認いただけます。\n\n闇手紙・悪魔の囁き：各20,000 LIA（購入対象：全員）\n外部Botで闇市場のチケットを作成して依頼し、このパネルでお支払いください。入金確認後、運営が購入者専用の送信パネルを発行します。\n闇手紙は文章、悪魔の囁きは音声ファイルを匿名で相手専用のTCへ届けます。`,
