...
export const SALARY_PAYMENTS: Record<string, number> = {
  ...
  // 各カテゴリのリーダー
  [ROLE_IDS.MENSETU_LEADER]: 0,
  [ROLE_IDS.GIJUTU_LEADER]: 10000,
  [ROLE_IDS.GINKOU_LEADER]: 0,
  [ROLE_IDS.EVALUATION_LEADER]: 0,
  [ROLE_IDS.SHOP_LEADER]: 0,
  [ROLE_IDS.GAME_LEADER]: 0,
  [ROLE_IDS.SHOKUNIN_LEADER]: 0,
  [ROLE_IDS.EVENT_LEADER]: 0,
  [ROLE_IDS.MONSTER_LEADER]: 0,

  // 評価員
  [ROLE_IDS.EVALUATION_1KYUU]: 0,
  [ROLE_IDS.EVALUATION_2KYUU]: 0,
  [ROLE_IDS.EVALUATION_3KYUU]: 0,
  [ROLE_IDS.EVALUATION_BUIGINNER]: 0,

  // 各カテゴリの従業員
  [ROLE_IDS.MENSTUKAN]: 0,
  [ROLE_IDS.MENSTU_BUIGINNER]: 0,
  [ROLE_IDS.GINKOU_STAFF]: 0,
  [ROLE_IDS.SHOP_STAFF]: 0,
  [ROLE_IDS.GAME_STAFF]: 0,
  [ROLE_IDS.SHOKUNIN_STAFF]: 0,
  [ROLE_IDS.EVENT_STAFF]: 0,
  [ROLE_IDS.MONSTER_STAFF]: 0,
