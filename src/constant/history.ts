...
export const HISTORY_TITLE_MAPPER = {
  ...
  [PANEL_COMMAND_NAMES.HOTEL_VC_SECRET]: "【聖王の館】VIPホテル (1分)購入",
  [PANEL_COMMAND_NAMES.HOTEL_VC_SECRETLONG]: "【聖王の館】VIPホテル (2分)購入",
  [PANEL_COMMAND_NAMES.HOTEL_VC_FREEDOM]: "【聖王の館】フリーダム (1分)購入",
  [PANEL_COMMAND_NAMES.HOTEL_VC_FREEDOMLONG]: "【聖王の館】フリーダム (2分)購入",
