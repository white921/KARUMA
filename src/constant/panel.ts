...
export const SHOP_PANEL_MESSAGES = {
  TITLE: "ショップパネル",
  DESCRIPTION:
    "ショップの支払いはこちらのパネルから行ってください。\n支払い前に使用するチケットを選択し、商品名と割引適用後の支払い金額を入力してください。\n\n**【市場ガチャ】**\n1回5,000krmまたは招待ポイント1pt／合計で1日5回まで。\nホテル無料券・ショップ割引券は当選時に自動付与され、それぞれのパネルで利用できます。ショップ割引券は100万krm未満の商品にのみ使用できます。その他の無料券・教祖遠隔は、[総合お問い合わせ](https://discord.com/channels/1520329128883126392/1520368587255189545)にて教団市場チケットを切っていただき、当選メッセージを提示して利用してください。",
  VIEW: "残高確認",
  SHOP_SEND: `${CURRENCY_NAMES}支払い`,
  TICKET_VIEW: "チケット確認",
