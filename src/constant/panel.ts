...
export const SHOP_PANEL_MESSAGES = {
  TITLE: "ショップパネル",
  DESCRIPTION:
    "ショップの支払いはこちらのパネルから行ってください。\n支払い前に使用するチケットを選択し、商品名と割引適用後の支払い金額を入力してください。\n\n**【市場ガチャ】**\n1回5,000krmまたは招待ポイント1pt／合計で1日5回まで。\nホテル無料券・ショップ割引券は当選時に自動付与されます。ショップ割引券は100万krm未満の商品にのみ使用でき、使用時は[総合お問い合わせ](https://discord.com/channels/1520329128883126392/1520368587255189545)にて教団市場チケットを切り、割引券を使用する旨を従業員にお伝えください。その他の無料券・教祖遠隔は、[総合お問い合わせ](https://discord.com/channels/1520329128883126392/1520368587255189545)にて教団市場チケットを切っていただき、当選メッセージを提示して利用してください。",
  VIEW: "残高確認",
  SHOP_SEND: `${CURRENCY_NAMES}支払い`,
  TICKET_VIEW: "チケット確認",
...
export const CREATOR_EMBLEM_PANEL_MESSAGES = {
  TITLE: "クリエイター送金パネル",
  DESCRIPTION:
    "紋章の制作依頼に伴う送金はこちらから行ってください。\n支払い前に商品とクリエイターを選択し、内容を確認してください。\n\n**【料金】**\n・個人紋章：教団員 100,000krm／使徒・司教・鯖主 60,000krm\n・デカ紋章：使徒・司教・鯖主 150,000krm\n\n※個人紋章・デカ紋章とも、クリエイターへ直接送金されます。",
  PAY: "支払い",
  VIEW: "残高確認",
  ERROR: "クリエイター送金パネルチャンネルが見つからないか、無効な型です。",
  MEMBER_ONLY: "教団員・使徒・司教・鯖主のみ利用できます。",
  APOSTLE_ONLY: "デカ紋章は使徒・司教・鯖主のみ利用できます。",
