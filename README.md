...
- 教祖雑談無料・カスタムロール一週間・教祖遠隔・異端：利用時は[総合お問い合わせ](https://discord.com/channels/1520329128883126392/1520368587255189545)で教団市場チケットを切り、当選メッセージを提示する。教祖遠隔・異端は教祖さんをメンションする
