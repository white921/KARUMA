...
同じ相手への月間送金上限は500,000 LIAです。送金元が「皇帝」「英傑」「支配人」のいずれかのロールを持つ場合は、この上限を適用しません。コマンド・パネルの両方に適用し、受取側だけが対象ロールを持つ場合は免除しません。残高不足や不正な金額は従来どおり拒否します。

## 管理者の残高増減

皇帝・英傑・財務員は `/残高増減 ユーザー:@対象 増減額:1000 備考:報酬` で1,000 LIAを付与し、`増減額:-1000` で1,000 LIAを剥奪できます。備考は任意です。既存の管理者パネルと同じ付与・剥奪処理を使用し、実行者や銀行Botの残高は減りません。個人送金の月間上限も適用されません。
...
市場パネルで「市場ガチャを引く」を押すと、5,000LIAまたは招待ポイント1ptを選択できます。支払い方法を選んだ後、確認ボタンを押すと抽選します。2種類の抽選を合計して日本時間で1日5回までです。

`/招待ポイント追加 ユーザー ポイント` でユーザーの招待ポイントを追加できます。実行できるのは技術統括・鯖主・管理者・ショップリーダー・ショップ従業員です。ポイントの付与・消費履歴はDBに保存されます。

- シークレット無料チケット・フリーダム無料チケット：当選時に自動付与され、次回該当ホテルを選ぶと優先して消費される
- 遊戯チケット：遊戯VC作成用。市場ガチャで1枚（12.5%）または3枚（6.5%）が当選し、所持している場合はゲームパネルから24時間の遊戯VCを1部屋無料で作成できる
- 市場割引券：市場ガチャで5%OFF（5%）・10%OFF（2%）が自動付与される。利用時は総合お問い合わせで市場チケットを切り、商人に割引後の支払額を確認してから、その金額を市場パネルで送金する。100万LIA以上の商品には利用できない
- アイドルコラボ・サプボ指名・どこでも通行券・カスタムロール（1週間）・イベント提案券：利用時は[総合お問い合わせ](https://discord.com/channels/1534636292153807039/1534641084016230600)で市場チケットを切り、当選メッセージを提示する。アイドルコラボとサプボ指名は対象ロールを当選案内でメンションする
